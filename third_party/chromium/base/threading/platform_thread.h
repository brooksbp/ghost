...
// You should be instead be using a message-loop driven Thread, see thread.h.
...
public:
  ...
  static PltaformThreadId CurrentId();
  ...
  // |*thread_handle| will be assigned to the newly created thread,
  ...
  // the thread is set based on |priority|.  Can be usd in place of Create()
