...
// A class for enumerating the files in a proivded path. The order of the
// results is not guarenteed.
//
...
public:
 ...
 private:
  ...
  // However, be careful in specifying patterns that aren't cross pltaform
